...
func (cr *CinemaRouter) InitCinmaRouter(router *gin.RouterGroup) {
	...
	cinemaRouter := router.Group("/cinema")
	{
		...
		{
			cinemaPublicRouter.GET("/get_cinemas_for_showing_film/:film_id",
				cinemaController.GetCinemasForShowingFilm)
		}
	}
}
